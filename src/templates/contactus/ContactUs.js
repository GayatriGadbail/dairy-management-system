...
function ContactUs() {
  ...
  return (
    <nav className=''>
       <div className='bg-secondary text-light fs-4'>
      <h1>Contact-Us</h1>
     </div>
    ...
    <div className='w-50 '>
      ...
      <div className='w-50 border border-black mt-3 p-2 bg-dark color-primary' >
    <h1 className='text-dark border border-black bg-info-subtle fs-3 ' >
